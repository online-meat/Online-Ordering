            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 push-lg-4">
                        <h1 class="mb-6"><b>Products Lists</b></h1>
                        <h4 class="text-muted mb-0"><b>Select from the range of our Products below</b></h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <footer id="footer" class="bg-dark dark">
            ...
            <div class="container">
                ...
                <div class="footer-second-row">
                    <span class="text-muted">Copyright &copy; 2019 eMeat Australia<br>Design by eMeat.</span>
                </div>
            </div>
